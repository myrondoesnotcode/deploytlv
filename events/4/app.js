/* Deploy #4 — Attendee Intelligence portal (brand-light theme) */
...
/* ── data assembly ── */
const ATTENDEES = window.D4.attendees || [];
const MATCHES = window.D4.matches || [];
const TAG_COLORS = window.D4.tagColors || {};
const CLUSTERS = (window.D4.clusterDefs || []).map(d => ({
  ...d,
...
const BREAKOUTS = window.D4.breakoutGroups || [];
    ...
    <div style={{ background: BG, minHeight: "100vh", fontFamily: MONO, color: INK }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <Badge text="Deploy #04" bg={ACCENT} color={BLACK} />
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(20,17,8,0.55)", zIndex: 200, overflowY: "auto", padding: 20 }}
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
          <Badge text={revLabel(a.revenue)} bg={revStyle(a.revenue).background} color={revStyle(a.revenue).color} />          {a.role && <Badge text={(a.role === "HOST" ? "★ " : "🎤 ") + a.role} bg={BLACK} color={ACCENT} />}
